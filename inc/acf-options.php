...
function my_template_acf_mataboxes(){
    ...
    acf_add_local_field_group(array(
        ...
        'title' => 'Настройки секций товаров',
        'fields' => array(
            array(
                'key' => 'homeProducts_sections',
                'label' => 'Секции товаров',
                'name' => 'homeProducts_sections',
                'type' => 'repeater',
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'homeProducts_id',
                        'label' => 'ID секции(Уникальное значение! Только латинсие символы без пробелов!)',
                        'name' => 'homeProducts_id',
                        'type' => 'text',
                        'required' => 1,
                        'wrapper' => array (
                            'width' => '50',
